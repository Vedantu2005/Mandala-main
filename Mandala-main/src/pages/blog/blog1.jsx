      ...
      <nav className="flex items-center justify-between px-4 md:px-8 py-4 text-sm ml-0 md:ml-68 mt-24">
        <div className="flex items-center space-x-2">
          ...
          <span className="text-[#664000] font-lato font-semibold text-xs md:text-[12px] leading-[100%] tracking-[0%]">
            Finding the Still Point in a Noisy World
          </span>
        </div>
      </nav>
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8 py-8">
        ...
        <header className="text-center mb-12">
          <div className="relative flex justify-center mb-6">
            ...
            <div>
              <h2 className="relative mt-4 md:mt-0 text-[52px] md:text-[72px] font-[Playfair_Display] font-semibold text-[#4D3000] leading-tight md:leading-[80px] tracking-[-0.03em] text-left">
                Finding the Still Point in <br className="hidden md:block"/> a Noisy World
              </h2>
              <svg
        ...
        <article className="prose prose-lg md:prose-xl max-w-3xl text-black justify-center ml-0 md:ml-28 text-[20px] leading-[100%] font-normal italic tracking-normal font-[Lato] text-justify space-y-8">
          <p>
            In the chaos of our modern lives, the greatest revolution is not
            found in the streets – but in stillness.
          </p>
          <p>
            Years ago, I found myself sitting in a quiet chapel. No agenda. No
            words. Just a whisper inside me that said, "There's more to life
            than this noise." That moment marked the beginning of my journey
            toward the still point – a space within me that does not rise or
            fall with the tides of the world.
          </p>
          <p>
            We live in a culture that prizes movement. Hustle. Productivity.
            Noise. But the MandalaMethod™ teaches us something different: that
            transformation begins in quiet presence, in listening – not to
            respond, but to truly hear.
          </p>
          <div
            className="w-full"
          ...
          ></div>
          <p>
            As men, we are often taught to push forward, to lead with power, to
            conquer. But real power lies in compassionate presence, in the
            willingness to pause, to ask ourselves: "Am I moving from fear, or
            from love?"
          </p>
          <p>
            When I work with leaders through the MandalaMethod™, I often see
            the same realization dawning: that they've been seeking wholeness in
            the world outside, while true wholeness they needed was within them
            all along.
          </p>
          <div
            className="w-full"
          ...
          ></div>
          <p>
            The Mandala isn't a map. It's a mirror. And as you begin to walk its
            path – through reflection, shared stories, and intentional practices
            – you begin to unravel false self and return to your center.
          </p>
          <p className="font-medium">
            Here are a few practices I return to when I feel disconnected:
          </p>
          <ul className="space-y-8 pl-0">
            <li className="flex items-start space-x-3">
              <span className="text-black text-xl -mt-1">•</span>
              <div>
                Silent Morning – Begin the day with 10 minutes of silence before
                screens, goals, or conversations.
              </div>
            </li>
            <li className="flex items-start space-x-3">
              <span className="text-black text-xl -mt-1">•</span>
              <div>
                The Listening Circle – Create space with someone you trust to
            ...
            <li className="flex items-start space-x-3">
              <span className="text-black text-xl -mt-1">•</span>
              <div>
                Compassion Inquiry – Ask yourself daily: "What would love do
                here?"
              </div>
            </li>
          </ul>
          ...
          <div className="space-y-3">
            <p>The still point isn't a place.</p>
            <p>It's a remembering.</p>
            <p>A return to what was never gone.</p>
          </div>
          <div className="space-y-2">
            <p>When you find it, you don't need to shout to be heard.</p>
            <p>You simply become a presence others are drawn to.</p>
          </div>
        </article>
